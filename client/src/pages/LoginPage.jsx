...
export const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-center bg-cover flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col
    backdrop-blur-2xl'>
          {/* left */}
          ...
          <form onSubmit={onSubmitHandler}
           className='border-2 bg-white/8 text-white border-gray-500 flex p-6 flex-col 
